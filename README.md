...
[Github]()  |  [Email](mailto:adham.coder2023@gmail.com)

Front-end Developer with experience working on projects involving JavaScript, Vue , Vuex, HTML/CSS Preprocessors (LESS/SASS), RESTful APIs and version control (Git).
...
- **CSS frameworks** : Element-UI, Bootstrap
- **Additional** : Experience with collaborative development tools (Git , GitHub , Gitlab) , Webpack , Postman , Swagger , Yarn & NPM packages Slack, pm2
...
# Side projects
- [Currency-Converter](https://converter-test-app.netlify.app/), This is a test app and uses open api from [https://www.cbr-xml-daily.ru/daily_json.js](https://www.cbr-xml-daily.ru/daily_json.js)
